...
export GOOGLE_APPLICATION_CREDENTIALS=glass-gasket-415918-343073a9db42.json && uvicorn app.main:app --reload --port 8008
```

## Start for local android emulator
```
uvicorn app.main:app --reload --host 192.168.0.141 --port 8001
```
